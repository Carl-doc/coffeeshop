...
<section class="menu-preview-section" id="menu-preview">
    <div class="section-heading">
        ...
        <p>Top 4 most ordered drinks at Cafe Cruise.</p>
    </div>
            ...
            <?php while ($row = mysqli_fetch_assoc($popular)): ?>
                <div class="menu-card">
                    ...
                    <div class="menu-content">
                        ...
                        <p class="menu-desc">Most ordered drink</p>
                        <span>₱<?php echo number_format($row["price"], 2); ?></span>
                   
                        <a href="customer/login.php" class="add-to-cart-btn">Add to Cart</a>
                    </div>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
            <div class="menu-card">
                ...
                <div class="menu-content">
                    ...
                    <p class="menu-desc">Popular drinks will appear once orders are placed.</p>
                    <span>₱0.00</span>
                </div>
            </div>
        <?php endif; ?>
...
<section class="about-section" id="about">
    <div class="about-text">
        ...
        <a href="customer/login.php" class="about-btn">Get Started</a>
    </div>
